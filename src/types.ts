...
export type AppTab = 'landing' | 'onboarding' | 'explore' | 'chat' | 'profile' | 'privacy' | 'account' | 'trust_safety' | 'community' | 'admin' | 'gender-selection' | 'postcards' | 'reset-password' | 'cafe';
