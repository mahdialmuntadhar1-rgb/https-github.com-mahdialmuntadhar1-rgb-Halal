...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    dailyQuestion: 'Daily Marriage Question',
    seriousMarriageOnly: 'Serious marriage introductions only',
    heroCleanSub: 'Create a respectful marriage profile, explore compatible members, and join focused community questions without casual dating features.',
    exploreMembersFirst: 'Explore members first',
    basicMarriageProfile: 'Basic marriage profile',
    profileComplete: 'Your profile is {percent}% complete.',
    completeEssentials: 'Complete the essentials now. You can refine details later.',
    pleaseReview: 'Please review',
    stepOf: 'Step {step} of {total}',
    male: 'Male',
    female: 'Female',
    cityGovernorate: 'City / Governorate',
    maritalStatus: 'Marital status',
    marriageIntention: 'Marriage intention',
    shortBio: 'Short bio',
    lookingFor: 'What are you looking for?',
    privacyPreference: 'Privacy preference',
    intentionBadges: 'Serious intention badges',
    ...
    finish: 'Finish',
    skip: 'Skip',
    enterExplore: 'Enter Explore',
    confirm18: 'I confirm I am 18 or older and using this app only for serious marriage intentions.',
    age18Error: 'Age must be 18 or older.',
    confirm18Error: 'Please confirm you are 18 or older.',
    occupationRequired: 'Occupation is required.',
    bioRequired: 'Please write a short respectful bio.',
    lookingForRequired: 'Please describe what you are looking for.',
    occupationPlaceholder: 'Teacher, engineer, student...',
    bioPlaceholder: 'A respectful summary of your values, home goals, and personality.',
    lookingForPlaceholder: 'Describe the kind of spouse and family life you hope for.',
    seriousForMarriage: 'Serious for marriage',
    familyInvolved: 'Family involved',
    familyInvolvementWelcome: 'Family involvement welcome',
    readyForEngagement: 'Ready for engagement',
    studyingFirst: 'Studying first',
    single: 'Single',
    divorced: 'Divorced',
    widowed: 'Widowed',
    readyForMarriageSoon: 'Ready for marriage soon',
    familyDiscussionNeeded: 'Family discussion needed',
    exploreMembersTitle: 'Serious marriage profiles',
    exploreMembersSub: 'Browse with dignity: no swiping, no messaging, no friend requests in this MVP.',
    ...
    noMembersFound: 'No members found yet',
    tryChangingFilters: 'Try changing your city or filters.',
    showAllMembers: 'Show all members',
    compatibility: 'compatibility',
    fit: 'fit',
    privatePhotoNote: 'Photo privacy is respected until the member chooses otherwise.',
    profileReported: 'Profile reported for admin review.',
    savedProfilesUpdated: 'Saved profiles updated.',
    profileReady: 'Your respectful marriage profile is ready.',
    communityTitle: 'Respectful marriage discussions',
    communitySub: 'Focused topics only: marriage advice, family approval, engagement, traditions, respectful religious questions, and success stories.',
    askQuestion: 'Ask a question',
    shareThoughts: 'Share your thoughts',
    postPlaceholder: 'Ask a respectful marriage question or share a thoughtful idea...',
    marriageAdvice: 'Marriage advice',
    familyApproval: 'Family approval',
    engagementQuestions: 'Engagement questions',
    cultureTraditions: 'Culture and traditions',
    religiousQuestions: 'Religious/respectful questions',
    ...
    post: 'Post',
    comments: 'comments',
    addRespectfulAdvice: 'Add respectful advice...',
    noPostsYet: 'No community posts yet',
    startCommunity: 'Start with a respectful marriage question to help the community.',
    postReported: 'Post reported for admin review.',
    postCreated: 'Your question was posted respectfully.',
    adminPanel: 'Admin panel',
    heroSettings: 'Hero settings',
    manageHero: 'Manage hero',
    ...
    noReportsYet: 'No reports yet. Reported profiles and posts will appear here for admin action.',
    contentHidden: 'Content hidden from members.',
    adminAccessRequired: 'Admin access required',
    adminConfigNotice: 'Admin role is controlled by backend admin config.',
    previous: 'Previous',
    next: 'Next',
    page: 'Page',
    ...
    respectfulContentError: 'Please keep the community respectful and marriage-focused.',
    ...
    requestPendingSub: 'Waiting for receiver or admin review.',
  ...
  ar: {
    ...
    exploreMembers: 'استكشاف الأعضاء',
    communityQuestions: 'المجتمع والأسئلة',
    dailyQuestion: 'سؤال الزواج اليومي',
    seriousMarriageOnly: 'تعارف جاد للزواج فقط',
    heroCleanSub: 'أنشئ ملف زواج محترماً، وتصفح أعضاء مناسبين، وشارك في أسئلة مجتمعية هادفة دون ميزات تعارف عشوائية.',
    exploreMembersFirst: 'استكشف الأعضاء أولاً',
    basicMarriageProfile: 'ملف زواج أساسي',
    profileComplete: 'ملفك مكتمل بنسبة {percent}%.',
    completeEssentials: 'أكمل الأساسيات الآن ويمكنك تعديل التفاصيل لاحقاً.',
    pleaseReview: 'يرجى المراجعة',
    stepOf: 'الخطوة {step} من {total}',
    male: 'رجل',
    female: 'امرأة',
    cityGovernorate: 'المدينة / المحافظة',
    maritalStatus: 'الحالة الاجتماعية',
    marriageIntention: 'نية الزواج',
    shortBio: 'نبذة قصيرة',
    lookingFor: 'ما الذي تبحث عنه؟',
    privacyPreference: 'تفضيل الخصوصية',
    intentionBadges: 'شارات الجدية',
    visibleProfile: 'ملف ظاهر',
    blurPhoto: 'تمويه الصورة',
    privateProfile: 'ملف خاص',
    continue: 'متابعة',
    back: 'رجوع',
    finish: 'إنهاء',
    skip: 'تخطي',
    enterExplore: 'الدخول للتصفح',
    confirm18: 'أؤكد أن عمري 18 سنة أو أكثر وأن استخدامي للتطبيق لغرض الزواج الجاد فقط.',
    age18Error: 'يجب أن يكون العمر 18 سنة أو أكثر.',
    confirm18Error: 'يرجى تأكيد أن عمرك 18 سنة أو أكثر.',
    occupationRequired: 'يرجى إدخال العمل أو المهنة.',
    bioRequired: 'يرجى كتابة نبذة قصيرة ومحترمة.',
    lookingForRequired: 'يرجى كتابة ما تبحث عنه باختصار.',
    occupationPlaceholder: 'معلم، مهندس، طالب...',
    bioPlaceholder: 'نبذة محترمة عن القيم والشخصية وأهداف البيت.',
    lookingForPlaceholder: 'اكتب مواصفات الشريك والحياة الأسرية التي تتمناها.',
    seriousForMarriage: 'جاد للزواج',
    familyInvolved: 'العائلة مشاركة',
    familyInvolvementWelcome: 'مشاركة العائلة مرحب بها',
    readyForEngagement: 'جاهز للخطوبة',
    studyingFirst: 'الدراسة أولاً',
    single: 'أعزب',
    divorced: 'مطلق',
    widowed: 'أرمل',
    readyForMarriageSoon: 'جاهز للزواج قريباً',
    familyDiscussionNeeded: 'تحتاج إلى نقاش عائلي',
    exploreMembersTitle: 'ملفات زواج جادة ومحترمة',
    exploreMembersSub: 'تصفح بوقار: بدون سحب عشوائي، بدون رسائل، وبدون طلبات صداقة في هذه النسخة.',
    allGovernorates: 'كل المحافظات',
    savedProfiles: 'الملفات المحفوظة',
    saveProfile: 'حفظ الملف',
    saved: 'محفوظ',
    removeSaved: 'إزالة الحفظ',
    viewProfile: 'عرض الملف',
    noMembersFound: 'لا توجد ملفات مناسبة حالياً',
    tryChangingFilters: 'جرّب تغيير المحافظة أو الفلاتر.',
    showAllMembers: 'عرض كل الأعضاء',
    compatibility: 'توافق',
    fit: 'توافق',
    privatePhotoNote: 'خصوصية الصورة محفوظة حسب اختيار العضو.',
    profileReported: 'تم إرسال البلاغ للمراجعة.',
    savedProfilesUpdated: 'تم تحديث الملفات المحفوظة.',
    profileReady: 'تم تجهيز ملف الزواج الخاص بك.',
    communityTitle: 'نقاشات محترمة حول الزواج',
    communitySub: 'مواضيع مركزة فقط: نصائح الزواج، موافقة العائلة، الخطوبة، العادات، الأسئلة المحترمة، وقصص النجاح.',
    askQuestion: 'اسأل سؤالاً',
    shareThoughts: 'شارك أفكارك',
    postPlaceholder: 'اكتب سؤالاً محترماً عن الزواج أو شارك فكرة مفيدة...',
    marriageAdvice: 'نصائح الزواج',
    familyApproval: 'موافقة العائلة',
    engagementQuestions: 'أسئلة الخطوبة',
    cultureTraditions: 'الثقافة والتقاليد',
    religiousQuestions: 'أسئلة دينية محترمة',
    ...
    post: 'نشر',
    comments: 'تعليقات',
    addRespectfulAdvice: 'أضف نصيحة محترمة...',
    noPostsYet: 'لا توجد منشورات بعد',
    startCommunity: 'ابدأ بسؤال زواج محترم يساعد المجتمع.',
    postReported: 'تم إرسال المنشور للمراجعة.',
    postCreated: 'تم نشر السؤال باحترام.',
    adminPanel: 'لوحة الإدارة',
    heroSettings: 'إعدادات صور الواجهة',
    manageHero: 'إدارة الواجهة',
    ...
    noReportsYet: 'لا توجد بلاغات حالياً. ستظهر بلاغات الملفات والمنشورات هنا.',
    contentHidden: 'تم إخفاء المحتوى عن الأعضاء.',
    adminAccessRequired: 'يتطلب صلاحية الإدارة',
    adminConfigNotice: 'صلاحية الإدارة مضبوطة من إعدادات الخادم.',
    previous: 'السابق',
    next: 'التالي',
    page: 'الصفحة',
    ...
    respectfulContentError: 'يرجى إبقاء المجتمع محترماً ومركزاً على الزواج.',
    profileTarget: 'ملف',
    postTarget: 'منشور',
    openReport: 'بلاغ مفتوح',
    resolvedReport: 'تمت المعالجة',
  ...
  ku: {
    ...
    exploreMembers: 'گەڕان بە ئەندامان',
    communityQuestions: 'کۆمەڵگە و پرسیارەکان',
    dailyQuestion: 'پرسیاری ڕۆژانەی هاوسەرگیری',
    seriousMarriageOnly: 'ناسیاوی جدی تەنها بۆ هاوسەرگیری',
    heroCleanSub: 'پڕۆفایلێکی بەڕێزی هاوسەرگیری دروست بکە، ئەندامانی گونجاو ببینە، و بەشداری پرسیارە هادفەکانی کۆمەڵگە بکە.',
    exploreMembersFirst: 'سەرەتا ئەندامان ببینە',
    basicMarriageProfile: 'پڕۆفایلی بنەڕەتی هاوسەرگیری',
    profileComplete: 'پڕۆفایلەکەت {percent}% تەواوە.',
    completeEssentials: 'ئێستا زانیارییە گرنگەکان تەواو بکە. دواتر دەتوانیت وردەکاری بگۆڕیت.',
    pleaseReview: 'تکایە پێداچوونەوە بکە',
    stepOf: 'هەنگاوی {step} لە {total}',
    male: 'پیاو',
    female: 'ئافرەت',
    cityGovernorate: 'شار / پارێزگا',
    maritalStatus: 'دۆخی خێزانی',
    marriageIntention: 'نیازی هاوسەرگیری',
    shortBio: 'کورتەیەک دەربارەت',
    lookingFor: 'چی دەگەڕێیت؟',
    privacyPreference: 'خواستی تایبەتمەندی',
    intentionBadges: 'نیشانەکانی جدیبوون',
    visibleProfile: 'پڕۆفایلی دیار',
    blurPhoto: 'لێڵکردنی وێنە',
    privateProfile: 'پڕۆفایلی تایبەت',
    continue: 'بەردەوام بە',
    back: 'گەڕانەوە',
    finish: 'تەواوکردن',
    skip: 'تێپەڕاندن',
    enterExplore: 'چوونە بەشی گەڕان',
    confirm18: 'دڵنیا دەکەمەوە کە تەمەنم 18 ساڵ یان زیاترە و ئەپەکە تەنها بۆ نیازی جدی هاوسەرگیری بەکاردەهێنم.',
    age18Error: 'تەمەن دەبێت 18 ساڵ یان زیاتر بێت.',
    confirm18Error: 'تکایە دڵنیایی بدە کە تەمەنت 18 ساڵ یان زیاترە.',
    occupationRequired: 'تکایە پیشە یان کارت بنووسە.',
    bioRequired: 'تکایە کورتەیەکی بەڕێز بنووسە.',
    lookingForRequired: 'تکایە بە کورتی بنووسە چی دەگەڕێیت.',
    occupationPlaceholder: 'مامۆستا، ئەندازیار، خوێندکار...',
    bioPlaceholder: 'کورتەیەکی بەڕێز دەربارەی بەهاکانت، ئامانجی ماڵ و کەسایەتیت.',
    lookingForPlaceholder: 'ئەو هاوسەر و ژیانی خێزانییەی دەتهەوێت باس بکە.',
    seriousForMarriage: 'جدی بۆ هاوسەرگیری',
    familyInvolved: 'خێزان ئاگادارە',
    familyInvolvementWelcome: 'بەشداری خێزان پێشوازی لێدەکرێت',
    readyForEngagement: 'ئامادەیە بۆ خوازبێنی',
    studyingFirst: 'سەرەتا خوێندن',
    single: 'سینگڵ',
    divorced: 'جیابووەوە',
    widowed: 'بێوەژن/بێوەمێرد',
    readyForMarriageSoon: 'ئامادەیە بۆ هاوسەرگیری بە زوویی',
    familyDiscussionNeeded: 'پێویستی بە گفتوگۆی خێزانی هەیە',
    exploreMembersTitle: 'پڕۆفایلی جدی و بەڕێزی هاوسەرگیری',
    exploreMembersSub: 'بە ڕێزەوە بگەڕێ: بێ سوایپ، بێ نامەی تایبەت، و بێ داواکاری هاوڕێیەتی لەم وەشاندنەدا.',
    allGovernorates: 'هەموو پارێزگاکان',
    savedProfiles: 'پڕۆفایلە پاشەکەوتکراوەکان',
    saveProfile: 'پاشەکەوتکردنی پڕۆفایل',
    saved: 'پاشەکەوتکراوە',
    removeSaved: 'لابردنی پاشەکەوت',
    viewProfile: 'بینینی پڕۆفایل',
    noMembersFound: 'هێشتا هیچ ئەندامێک نەدۆزرایەوە',
    tryChangingFilters: 'هەوڵ بدە شار یان فلتەرەکان بگۆڕیت.',
    showAllMembers: 'هەموو ئەندامان پیشان بدە',
    compatibility: 'گونجان',
    fit: 'گونجان',
    privatePhotoNote: 'تایبەتمەندی وێنەکە بە خواستی ئەندامەکە پارێزراوە.',
    profileReported: 'پڕۆفایلەکە بۆ پێداچوونەوەی بەڕێوەبەر نێردرا.',
    savedProfilesUpdated: 'پڕۆفایلە پاشەکەوتکراوەکان نوێکرانەوە.',
    profileReady: 'پڕۆفایلی بەڕێزی هاوسەرگیرییەکەت ئامادەیە.',
    communityTitle: 'گفتوگۆی بەڕێز دەربارەی هاوسەرگیری',
    communitySub: 'تەنها بابەتی هادف: ئامۆژگاری هاوسەرگیری، ڕەزامەندی خێزان، خوازبێنی، دابونەریت، پرسیاری ئایینی بەڕێز، و چیرۆکی سەرکەوتن.',
    askQuestion: 'پرسیار بکە',
    shareThoughts: 'بیرۆکەت هاوبەش بکە',
    postPlaceholder: 'پرسیارێکی بەڕێزی هاوسەرگیری بکە یان بیرۆکەیەکی سوودبەخش بنووسە...',
    marriageAdvice: 'ئامۆژگاری هاوسەرگیری',
    familyApproval: 'ڕەزامەندی خێزان',
    engagementQuestions: 'پرسیارەکانی خوازبێنی',
    cultureTraditions: 'کلتور و دابونەریت',
    religiousQuestions: 'پرسیاری ئایینی/بەڕێز',
    ...
    post: 'بڵاوکردنەوە',
    comments: 'کۆمێنت',
    addRespectfulAdvice: 'ئامۆژگارییەکی بەڕێز زیاد بکە...',
    noPostsYet: 'هێشتا هیچ بابەتێک نییە',
    startCommunity: 'بە پرسیارێکی بەڕێزی هاوسەرگیری دەست پێبکە بۆ یارمەتیدانی کۆمەڵگە.',
    postReported: 'بابەتەکە بۆ پێداچوونەوەی بەڕێوەبەر نێردرا.',
    postCreated: 'پرسیارەکەت بە ڕێزەوە بڵاوکرایەوە.',
    adminPanel: 'پانێلی بەڕێوەبەر',
    heroSettings: 'ڕێکخستنی وێنەی سەرەکی',
    manageHero: 'بەڕێوەبردنی وێنەی سەرەکی',
    manageUsers: 'بەڕێوەبردنی بەکارهێنەران',
    managePosts: 'بەڕێوەبردنی بابەتەکان',
    manageReports: 'بەڕێوەبردنی ڕاپۆرتەکان',
    addImage: 'زیادکردنی وێنە',
    replaceImage: 'گۆڕینی وێنە',
    removeImage: 'لابردنی وێنە',
    changeOrder: 'گۆڕینی ڕیزبەندی',
    active: 'چالاک',
    inactive: 'ناچالاک',
    ...
    reportedContent: 'ناوەڕۆکی ڕاپۆرتکراو',
    noReportsYet: 'هێشتا هیچ ڕاپۆرتێک نییە. ڕاپۆرتی پڕۆفایل و بابەتەکان لێرە دەردەکەون.',
    contentHidden: 'ناوەڕۆکەکە لە ئەندامان شاردرایەوە.',
    adminAccessRequired: 'دەسەڵاتی بەڕێوەبەر پێویستە',
    adminConfigNotice: 'ڕۆڵی بەڕێوەبەر لە ڕێکخستنی سێرڤەرەوە کۆنترۆڵ دەکرێت.',
    previous: 'پێشوو',
    next: 'دواتر',
    page: 'پەڕە',
    ...
    respectfulContentError: 'تکایە کۆمەڵگەکە بەڕێز و تایبەت بە هاوسەرگیری بهێڵەوە.',
    profileTarget: 'پڕۆفایل',
    postTarget: 'بابەت',
    openReport: 'ڕاپۆرتی کراوە',
    resolvedReport: 'چارەسەرکراوە',
    email: 'ئیمەیڵ',
    password: 'وشەی نهێنی',
    confirmPassword: 'دڵنیابوون لە وشەی نهێنی',
    ...
    registrationFailed: 'دروستکردنی هەژمار سەرکەوتوو نەبوو',
