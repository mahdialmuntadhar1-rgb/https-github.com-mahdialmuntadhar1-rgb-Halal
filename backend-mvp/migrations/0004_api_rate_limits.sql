-- Non-destructive. Same table StudentHUB already uses on shared rafid-db.
-- HALAL must NEVER run StudentHUB migrations against this D1.
-- CREATE TABLE IF NOT EXISTS is a no-op if StudentHUB already created it.
