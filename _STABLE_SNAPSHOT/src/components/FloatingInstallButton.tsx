          ...
          <div className="bg-white rounded-3xl p-5 sm:p-6 max-w-md w-full relative border border-stone-200 shadow-2xl text-start">
            ...
            <div className="text-center space-y-3 mb-5">
              ...
              <h3 className="text-lg sm:text-xl font-serif font-black text-warm-charcoal">
                {txt('Download Zawaj Al Araqi App', '????? ????? ?????? ???????', '?????????? ???? ?????')}
              </h3>
            ...
            {guideTab === 'android' && (
              <div className="space-y-3.5 bg-stone-50 p-4 rounded-2xl border border-stone-200/50">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs font-bold text-warm-charcoal">
                      {txt('Open Chrome Menu', '???? ????? ??????', '?????? Chrome ???????')}
                    </p>
                    <p className="text-[11px] text-[#6B635B]">
                      {txt('Tap the three dots (?) in the top-right or bottom-right corner.', '???? ??? ?????? ?????? (?) ?? ????? ???????.', '?? ?????? (?) ?? ????? ?????? ??? ???????? ?????????? ??????.')}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs font-bold text-warm-charcoal">
                      {txt('Tap "Install App" or "Add to Home Screen"', '???? ??? "????? ???????" ?? "??????? ??????"', '?????? "Install app" ??? "Add to Home screen"')}
                    </p>
                    <p className="text-[11px] text-[#6B635B]">
                      {txt('Confirm the dialog prompt to complete the installation.', '??? ????? ??????? ?????? ??????? ?????? ?????.', '???????? ??????? ?? ?????????? ????????????.')}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {guideTab === 'ios' && (
              <div className="space-y-3.5 bg-stone-50 p-4 rounded-2xl border border-stone-200/50">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs font-bold text-warm-charcoal flex items-center gap-1.5">
                      {txt('Tap the Share button', '???? ??? ?? ????????', '?????? ?????????? (Share) ??????')}
                      <Share2 className="w-3.5 h-3.5 text-blue-500 inline shrink-0" />
                    </p>
                    <p className="text-[11px] text-[#6B635B]">
                      {txt('Located at the bottom of your Safari browser.', '??????? ?? ?????? ?????? ?????? ????? (Safari).', '?? ?? ???????? ??????? Safari ????.')}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs font-bold text-warm-charcoal flex items-center gap-1.5">
                      {txt('Select "Add to Home Screen"', '???? "????? ??? ?????? ????????"', '????? ??? "Add to Home Screen"')}
                      <PlusSquare className="w-3.5 h-3.5 text-stone-600 inline shrink-0" />
                    </p>
                    <p className="text-[11px] text-[#6B635B]">
                      {txt('Scroll down the menu to find and select this option.', '?? ???????? ????? ??????? ??????? ??? ?????? ????????.', '??? ???????? ???????? ?? ????????? ??? ????????.')}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {guideTab === 'desktop' && (
              <div className="space-y-3.5 bg-stone-50 p-4 rounded-2xl border border-stone-200/50">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs font-bold text-warm-charcoal">
                      {txt('Look at the Address Bar', '???? ??? ???? ???????', '????? ????? ???????? ???')}
                    </p>
                    <p className="text-[11px] text-[#6B635B]">
                      {txt('Click the "Install" computer-icon (or circle plus) on the right side of your URL bar.', '???? ??? ?????? ???? ????????? (?? ????? ????) ?? ???? ???? ???????.', '???? ????? ??????? ????????? ??? ???? ??? ?? ??? ????? ????????? ??????.')}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs font-bold text-warm-charcoal">
                      {txt('Using Browser Menu', '?? ???? ????? ???????', '??????????? ?????? ??????')}
                    </p>
                    <p className="text-[11px] text-[#6B635B]">
                      {txt('Alternatively, open browser menu (?), choose "Save and share", then click "Install page".', '????? ?? ???? ???? ??????? (?) ????? "??? ???????" ?? ???? "????? ??????".', '??? ????? ??????? (?) ? ??? ???? "Save and share" ? "Install page" ????? ???.')}
                    </p>
                  </div>
                </div>
              </div>
